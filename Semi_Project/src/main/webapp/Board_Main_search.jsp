...
<div align="center">
	...
	<%-- 페이징 처리 영역 --%>
		<nav>
			<ul class="pagination">
				<li class="page-item">
					<a class="page-link" href="board_main_search.do?page=1&field=${field}&keyword=${keyword}">First</a>
				</li>
				<li>
					<a class="page-link" href="board_main_search.do?page=${page -1 }&field=${field}&keyword=${keyword}">Previous</a>
				</li>
				
				<c:forEach begin="${startBlock }" end="${endBlock }" var ="i">
					<c:if test="${i == page }">
					<li class= "page-item active" aria-current="page">
						<a class="page-link" href="board_main_search.do?page=${i }&field=${field}&keyword=${keyword}">${i }</a>
					</li>				
					</c:if>
				...
				<c:if test="${endBlock < allPage }">
					<li class= "page-item" >
						<a class="page-link" href="board_main_search.do?page=${page +1 }&field=${field}&keyword=${keyword}">Next</a>
					</li>	
				</c:if>
				<li class= "page-item" >
					<a class="page-link" href="board_main_search.do?page=${allPage}&field=${field}&keyword=${keyword}">End</a>
				</li>	
			</ul>
		</nav>		
