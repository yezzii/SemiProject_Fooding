			...
			<div class="col-lg-8 col-md-10 mt-sm-3">
				...
				<ol class="list-unstyled">
					<li><span class="font-weight-semibold text-primary mr-2">1.</span>회원가입
						하신 이름, 아이디, 이메일을 작성해주세요.</li>
					<li><span class="font-weight-semibold text-primary mr-2">2.</span>비밀번호
						찾기 버튼을 눌러주세요.</li>
					<li><span class="font-weight-semibold text-primary mr-2">3.</span>가입하신
						이메일로 임시비밀번호가 전송됩니다.</li>
					<li><span class="font-weight-semibold text-primary mr-2">4.</span>받으신
						임시 비밀번호로 로그인 후 비밀번호를 변경해주세요.</li>
				</ol>
				<div class="card py-2 mt-4">
					<form class="card-body needs-validation" novalidate method="post"
						action="<%=request.getContextPath()%>/find_pwd.do">
						<div class="alert alert-success" role="alert"
							style="display: none">
							<h4 class="pt-2 alert-heading">이메일 전송 성공</h4>
							<p id="success_content">
								회원님의 비밀번호가 임시비밀번호로 변경되었습니다. 이메일을 확인해주세요. 메인페이지로 이동하시려면 <a
									href="index.jsp">여기</a>를 눌러주세요.
							</p>
						</div>
						<div class="alert alert-danger" role="alert" style="display: none">
							<h4 class="pt-2 alert-heading">비밀번호 찾기 실패</h4>
							<p id="success_content">입력하신 것에 대한 회원정보를 찾을 수 없습니다. 다시
								시도해주세요.</p>
						</div>
						<div class="form-group">
							<label for="recover-pwd-name">이름</label> <input
								class="form-control" type="text" id="recover-pwd-name"
								name="recover-pwd-name" required>
							<div class="invalid-feedback"></div>
						</div>
						<div class="form-group">
							<label for="recover-pwd-id">아이디</label> <input
								class="form-control" type="text" id="recover-pwd-id"
								name="recover-pwd-id" required>
							<div class="invalid-feedback"></div>
						</div>
						<div class="form-group">
							<label for="recover-pwd-email">이메일</label> <input
								class="form-control" type="email" id="recover-pwd-email"
								name="recover-pwd-email" required>
							<div class="invalid-feedback"></div>
						</div>
						<button class="btn btn-primary" type="button" id="FindPwdBtn">비밀번호
							찾기</button>
