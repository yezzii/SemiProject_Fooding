  ...
  window.addEventListener(
    ...
    function () {
      ...
      Array.prototype.filter.call(t, function (a) {
        a.addEventListener(
          ...
          function (event) {
            if (!a.checkValidity()) {
              event.preventDefault(); // 이 부분이 추가된 부분입니다.
    ...
    false
            ...
            searchAutocomplete: function(t) {
                c.fn.easyAutocomplete && c("#site-search").easyAutocomplete({
                    ...
                    template: {
                        type: "custom",
                        method: function(t, a) {
                            return "<a href='" + a.link + "'><span class='ac-title'>" + t + "</span><span class='badge badge-" + a.badge + " ml-2'>" + a.type + "</span></a>"
                        }
                    }
                })
            },
