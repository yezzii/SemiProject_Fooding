    ...
    <div class="container pt-lg-3 pb-5 mb-sm-3">
      <div class="row pt-5">
        ...
        <div class="col-lg-8 offset-xl-1">
          ...
          <hr class="pb-3">
          <!-- Ticket-->
          <div class="d-flex pt-3 flex-wrap justify-content-between align-items-center">
            <h5 class="mb-3 mr-2">Single ticket example</h5>
            <div class="mb-3"><a class="btn btn-outline-secondary" href="account-orders.html"><i class="mr-1" data-feather="settings"></i>Back to dashboard</a></div>
          </div>
          <div class="d-sm-flex justify-content-between font-size-sm bg-secondary py-3 mb-3">
            <div class="p-2 w-100 text-center"><strong class="d-block mb-1">Date Submitted</strong><span>05/08/2019</span></div>
            <div class="py-2 w-100 text-center"><strong class="d-block mb-1">Last Updated</strong><span>05/14/2019</span></div>
            <div class="py-2 w-100 text-center"><strong class="d-block mb-1">Type</strong><span>Website problem</span></div>
            <div class="py-2 w-100 text-center"><strong class="d-block mb-1">Priority</strong><span class="badge badge-warning">High</span></div>
            <div class="py-2 w-100 text-center"><strong class="d-block mb-1">Status</strong><span class="badge badge-primary">Open</span></div>
          </div>
          <!-- Comment-->
          <div class="blockquote comment mb-4">
            <p>Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus, omnis voluptas assumenda est.</p>
            <div class="media align-items-center mb-2"><img class="mr-3" src="img/testimonials/01.jpg" width="50" alt="Author ava">
              <div class="media-body">
                <h6 class="font-size-sm mb-0">Jonathan Smith</h6><span class="d-block font-size-sm text-muted">May 17, 2019 at 11:05AM</span>
              </div>
            </div>
          </div>
          <!-- Comment-->
          <div class="blockquote comment mb-4">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Utenim ad minim veniam, quis nostrud. Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus, omnis voluptas assumenda est cum soluta nobis.</p>
            <div class="media align-items-center mb-2"><img class="mr-3" src="img/testimonials/01.jpg" width="50" alt="Author ava">
              <div class="media-body">
                <h6 class="font-size-sm mb-0">Jonathan Smith</h6><span class="d-block font-size-sm text-muted">May 14, 2019 at 3:10PM</span>
              </div>
            </div>
            <!-- Reply-->
            <div class="blockquote comment mt-4 mb-0">
              ...
              <div class="media align-items-center mb-2"><img class="mr-3" src="img/testimonials/02.jpg" width="50" alt="Author ava">
                <div class="media-body">
                  <h6 class="font-size-sm mb-0">Daniel Adams</h6><span class="d-block font-size-sm text-muted">May 13, 2019 at 5:00PM</span>
                </div>
              </div>
            </div>
          </div>
          <!-- Leave message-->
          <h3 class="h6 pt-4 pb-2">Leave a Message</h3>
          <form class="needs-validation" novalidate>
            <div class="form-group">
