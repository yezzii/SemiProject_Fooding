      ...
      <div class="container">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="help-topics.html">Help center</a>
            </li>
          </ol>
        </nav>
        <h1 class="page-title">Single topic</h1><span class="d-block mt-2 text-muted"></span>
        <hr class="mt-4">
      </div>
    </div>
    <!-- Page Content-->
      ...
      <div class="row">
          ...
          <div class="offcanvas-sidebar">
            ...
            <div class="offcanvas-sidebar-body">
              <div class="widget widget-links">
                ...
                <ul>
                  <li><a href="#"><i class="widget-categories-indicator" data-feather="chevron-right"></i>Managing account</a></li>
                  <li><a href="#"><i class="widget-categories-indicator" data-feather="chevron-right"></i>Working with dashboard</a></li>
                  <li><a href="#"><i class="widget-categories-indicator" data-feather="chevron-right"></i>Available payment methods</a></li>
                  <li><a href="#"><i class="widget-categories-indicator" data-feather="chevron-right"></i>Delivery information</a></li>
                  <li><a href="#"><i class="widget-categories-indicator" data-feather="chevron-right"></i>Order tracking instructions</a></li>
                  <li><a href="#"><i class="widget-categories-indicator" data-feather="chevron-right"></i>Refund policy</a></li>
                  <li><a href="#"><i class="widget-categories-indicator" data-feather="chevron-right"></i>Offers and discounts</a></li>
                  <li><a href="#"><i class="widget-categories-indicator" data-feather="chevron-right"></i>Reward points</a></li>
                  <li><a href="#"><i class="widget-categories-indicator" data-feather="chevron-right"></i>Affiliate program</a></li>
                  <li><a href="#"><i class="widget-categories-indicator" data-feather="chevron-right"></i>After purchase support</a></li>
                  <li><a href="#"><i class="widget-categories-indicator" data-feather="chevron-right"></i>Service terms &amp; conditions</a></li>
                  <li><a href="#"><i class="widget-categories-indicator" data-feather="chevron-right"></i>Most popular questions</a></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div class="col-xl-9 col-lg-8">
          ...
          <div class="row pt-3 pb-4 mb-2 mb-md-4">
            ...
            <div class="col-md-5 pt-4">
              ...
              <ul class="list-unstyled font-size-sm pt-2">
                <li class="d-flex align-items-center mb-1"><i class="text-success mr-2" data-feather="check" style="width: 1rem; height: 1rem;"></i><span>Ut enim ad minima veniam, quis nostrum</span></li>
                <li class="d-flex align-items-center mb-1"><i class="text-success mr-2" data-feather="check" style="width: 1rem; height: 1rem;"></i><span>At vero eos et accusamus et iusto odio</span></li>
                <li class="d-flex align-items-center mb-1"><i class="text-success mr-2" data-feather="check" style="width: 1rem; height: 1rem;"></i><span>Nam libero tempore, cum soluta nobis</span></li>
                <li class="d-flex align-items-center mb-1"><i class="text-success mr-2" data-feather="check" style="width: 1rem; height: 1rem;"></i><span>Et harum quidem rerum facilis est et expedita</span></li>
                <li class="d-flex align-items-center mb-1"><i class="text-success mr-2" data-feather="check" style="width: 1rem; height: 1rem;"></i><span>Quis autem vel eum iure reprehenderit</span></li>
                <li class="d-flex align-items-center mb-1"><i class="text-success mr-2" data-feather="check" style="width: 1rem; height: 1rem;"></i><span>Excepteur sint occaecat cupidatat non</span></li>
              </ul>
            </div>
          </div>
          ...
          <div class="accordion" id="methods">
            <div class="card">
              <div class="card-header">
                <h3 class="accordion-heading"><a href="#methodOne" role="button" data-toggle="collapse" aria-expanded="true" aria-controls="methodOne">Credit / debit cards<span class="accordion-indicator"><i data-feather="chevron-up"></i></span></a></h3>
              </div>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="accordion-heading"><a class="collapsed" href="#methodTwo" role="button" data-toggle="collapse" aria-expanded="true" aria-controls="methodTwo">Pay with PayPal<span class="accordion-indicator"><i data-feather="chevron-up"></i></span></a></h3>
              </div>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="accordion-heading"><a class="collapsed" href="#methodThree" role="button" data-toggle="collapse" aria-expanded="true" aria-controls="methodThree">Redeem reward points<span class="accordion-indicator"><i data-feather="chevron-up"></i></span></a></h3>
              </div>
          ...
          <div class="text-center pt-5 mt-2">
            <h4 class="pb-3">Haven't found the answer? We can help.</h4>
            <div class="mb-2">
