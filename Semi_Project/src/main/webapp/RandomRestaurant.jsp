...
<body>
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="index.jsp"
						style="font-family: 'GmarketSansMedium';">Home</a></li>
					<li class="breadcrumb-item"><a href="#"
						style="font-family: 'GmarketSansMedium';">레스토랑 추천</a></li>
				</ol>
			</nav>
			<h1 class="page-title" style="font-family: 'GmarketSansMedium';">
				레스토랑 추천&nbsp;🎲 <span class="lead font-weight-semibold text-muted"></span>
			</h1>
	...
	<div class="bg-secondary">
		<div class="px-3 pt-8 pb-md-4 pt-md-4 text-center">
			...
			<h2 class="h3 pb-2" style="font-family: 'GmarketSansMedium';">다시
				추천받기</h2>
