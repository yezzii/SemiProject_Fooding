		...
		<nav aria-label="Page navigation">
			<ul
				...
				<li class="page-item"><a class="page-link"
					href="review_board.do?page=1">처음</a></li>
				<li class="page-item"><a class="page-link"
					href="review_board.do?page=${page - 1 }">이전</a></li>
				...
				<c:forEach begin="${startBlock }" end="${endBlock }" var="i">
					...
					<c:if test="${i != page }">
						<li class="page-item"><a class="page-link"
							href="review_board.do?page=${i }">${i }</a></li>
					</c:if>
				</c:forEach>

				<c:if test="${endBlock < allPage }">
					<li class="page-item"><a class="page-link"
						href="review_board.do?page=${page + 1 }">다음</a></li>

					<li class="page-item"><a class="page-link"
						href="review_board.do?page=${allPage }">마지막</a></li>
				</c:if>
