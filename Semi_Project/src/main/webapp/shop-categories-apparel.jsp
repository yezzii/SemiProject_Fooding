  ...
  <body>
    ...
    <div class="page-title-wrapper" aria-label="Page title">
      <div class="container">
        ...
        <h1 class="page-title">Categories - Apparel</h1><span class="d-block mt-2 text-muted"></span>
        <hr class="mt-4">
      </div>
    </div>
    <!-- Page Content-->
    <div class="container pb-5 mb-sm-1">
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-6">
          <div class="card border-0 mb-grid-gutter"><a class="card-img-tiles" href="shop-style1-ls.jsp">
            ...
            <div class="card-body border mt-n1 py-4 text-center">
              <h2 class="h5 mb-1">Clothing</h2><span class="d-block mb-3 font-size-xs text-muted">Starting from <span class='font-weight-semibold'>$49.99</span></span><a class="btn btn-pill btn-outline-primary btn-sm" href="shop-style1-ls.jsp">Shop clothing</a>
            </div>
          </div>
        </div>
        <!-- Category-->
        <div class="col-md-4 col-sm-6">
          <div class="card border-0 mb-grid-gutter"><a class="card-img-tiles" href="shop-style1-ls.jsp">
            ...
            <div class="card-body border mt-n1 py-4 text-center">
              <h2 class="h5 mb-1">Shoes</h2><span class="d-block mb-3 font-size-xs text-muted">Starting from <span class='font-weight-semibold'>$56.00</span></span><a class="btn btn-pill btn-outline-primary btn-sm" href="shop-style1-ls.jsp">Shop shoes</a>
            </div>
          </div>
        </div>
        <!-- Category-->
        <div class="col-md-4 col-sm-6">
          <div class="card border-0 mb-grid-gutter"><a class="card-img-tiles" href="shop-style1-ls.jsp">
            ...
            <div class="card-body border mt-n1 py-4 text-center">
              <h2 class="h5 mb-1">Bags</h2><span class="d-block mb-3 font-size-xs text-muted">Starting from <span class='font-weight-semibold'>$27.00</span></span><a class="btn btn-pill btn-outline-primary btn-sm" href="shop-style1-ls.jsp">Shop bags</a>
            </div>
          </div>
        </div>
        <!-- Category-->
        <div class="col-md-4 col-sm-6">
          <div class="card border-0 mb-grid-gutter"><a class="card-img-tiles" href="shop-style1-ls.jsp">
              <div class="main-img"><img src="img/shop/apparel/categories/10.jpg" alt="Sunglasses"></div>
              <div class="thumblist"><img src="img/shop/apparel/categories/12.jpg" alt="Sunglasses"><img src="img/shop/apparel/categories/11.jpg" alt="Sunglasses"></div></a>
            <div class="card-body border mt-n1 py-4 text-center">
              <h2 class="h5 mb-1">Sunglasses</h2><span class="d-block mb-3 font-size-xs text-muted">Starting from <span class='font-weight-semibold'>$35.99</span></span><a class="btn btn-pill btn-outline-primary btn-sm" href="shop-style1-ls.jsp">Shop sunglasses</a>
            </div>
          </div>
        </div>
        <!-- Category-->
        <div class="col-md-4 col-sm-6">
          <div class="card border-0 mb-grid-gutter"><a class="card-img-tiles" href="shop-style1-ls.jsp">
              <div class="main-img"><img src="img/shop/apparel/categories/13.jpg" alt="Hats"></div>
              <div class="thumblist"><img src="img/shop/apparel/categories/14.jpg" alt="Hats"><img src="img/shop/apparel/categories/15.jpg" alt="Hats"></div></a>
            <div class="card-body border mt-n1 py-4 text-center">
              <h2 class="h5 mb-1">Hats</h2><span class="d-block mb-3 font-size-xs text-muted">Starting from <span class='font-weight-semibold'>$14.50</span></span><a class="btn btn-pill btn-outline-primary btn-sm" href="shop-style1-ls.jsp">Shop hats</a>
            </div>
          </div>
        </div>
        <!-- Category-->
        <div class="col-md-4 col-sm-6">
          <div class="card border-0 mb-grid-gutter"><a class="card-img-tiles" href="shop-style1-ls.jsp">
              <div class="main-img"><img src="img/shop/apparel/categories/16.jpg" alt="Gloves"></div>
              <div class="thumblist"><img src="img/shop/apparel/categories/17.jpg" alt="Gloves"><img src="img/shop/apparel/categories/18.jpg" alt="Gloves"></div></a>
            <div class="card-body border mt-n1 py-4 text-center">
              <h2 class="h5 mb-1">Gloves</h2><span class="d-block mb-3 font-size-xs text-muted">Starting from <span class='font-weight-semibold'>$10.45</span></span><a class="btn btn-pill btn-outline-primary btn-sm" href="shop-style1-ls.jsp">Shop accessories</a>
            </div>
          </div>
        </div>
      </div>
      <!-- Popular brands-->
      <h2 class="h3 pt-4 pt-md-5 text-center">Popular brands</h2>
      <div class="row pt-4">
        <div class="col-md-3 col-sm-4 col-6"><a class="d-block bg-white border py-3 py-sm-4 mb-grid-gutter" href="#"><img class="d-block mx-auto" src="img/shop/apparel/brands/01.png" style="width: 150px;" alt="Brand"></a></div>
        <div class="col-md-3 col-sm-4 col-6"><a class="d-block bg-white border py-3 py-sm-4 mb-grid-gutter" href="#"><img class="d-block mx-auto" src="img/shop/apparel/brands/02.png" style="width: 150px;" alt="Brand"></a></div>
        <div class="col-md-3 col-sm-4 col-6"><a class="d-block bg-white border py-3 py-sm-4 mb-grid-gutter" href="#"><img class="d-block mx-auto" src="img/shop/apparel/brands/03.png" style="width: 150px;" alt="Brand"></a></div>
        <div class="col-md-3 col-sm-4 col-6"><a class="d-block bg-white border py-3 py-sm-4 mb-grid-gutter" href="#"><img class="d-block mx-auto" src="img/shop/apparel/brands/04.png" style="width: 150px;" alt="Brand"></a></div>
        <div class="col-md-3 col-sm-4 col-6"><a class="d-block bg-white border py-3 py-sm-4 mb-grid-gutter" href="#"><img class="d-block mx-auto" src="img/shop/apparel/brands/05.png" style="width: 150px;" alt="Brand"></a></div>
        <div class="col-md-3 col-sm-4 col-6"><a class="d-block bg-white border py-3 py-sm-4 mb-grid-gutter" href="#"><img class="d-block mx-auto" src="img/shop/apparel/brands/06.png" style="width: 150px;" alt="Brand"></a></div>
        <div class="col-md-3 col-sm-4 col-6"><a class="d-block bg-white border py-3 py-sm-4 mb-grid-gutter" href="#"><img class="d-block mx-auto" src="img/shop/apparel/brands/07.png" style="width: 150px;" alt="Brand"></a></div>
        <div class="col-md-3 col-sm-4 col-6"><a class="d-block bg-white border py-3 py-sm-4 mb-grid-gutter" href="#"><img class="d-block mx-auto" src="img/shop/apparel/brands/08.png" style="width: 150px;" alt="Brand"></a></div>
        <div class="col-md-3 col-sm-4 col-6"><a class="d-block bg-white border py-3 py-sm-4 mb-grid-gutter" href="#"><img class="d-block mx-auto" src="img/shop/apparel/brands/09.png" style="width: 150px;" alt="Brand"></a></div>
        <div class="col-md-3 col-sm-4 col-6"><a class="d-block bg-white border py-3 py-sm-4 mb-grid-gutter" href="#"><img class="d-block mx-auto" src="img/shop/apparel/brands/10.png" style="width: 150px;" alt="Brand"></a></div>
        <div class="col-md-3 col-sm-4 col-6"><a class="d-block bg-white border py-3 py-sm-4 mb-grid-gutter" href="#"><img class="d-block mx-auto" src="img/shop/apparel/brands/11.png" style="width: 150px;" alt="Brand"></a></div>
        <div class="col-md-3 col-sm-4 col-6"><a class="d-block bg-white border py-3 py-sm-4 mb-grid-gutter" href="#"><img class="d-block mx-auto" src="img/shop/apparel/brands/12.png" style="width: 150px;" alt="Brand"></a></div>
      </div>
    </div>
    <!-- Footer-->
