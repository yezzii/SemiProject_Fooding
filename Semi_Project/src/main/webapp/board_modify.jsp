...
<body>
	...
	<div class="page-title-wrapper" aria-label="Page title">
		<div class="container">
			...
			<h1 class="page-title">${dto.getBoard_writer()}님의게시글 수정페이지.</h1>
	...
	<div class="container pb-5 mb-1">
		<div class="row justify-content-center">
			<div class="col-lg-9">
				<form action="<%=request.getContextPath()%>/board_modify_ok.do"
					method="post">
					...
					<!-- Post meta-->
					<div
						class="post-meta d-flex flex-wrap justify-content-between pb-3">
						<div>
					...
					<div class="form-group">
						...
						<label for="text-input">글제목</label> <input class="form-control"
							type="text" id="text-input" value="${dto.getBoard_title()}"
							name="title">
					</div>

					<label for="textarea-input">글내용</label>
					<textarea rows="15" cols="" class="form-control" name="cont"
						id="textarea-input">${dto.getBoard_content()}</textarea>
