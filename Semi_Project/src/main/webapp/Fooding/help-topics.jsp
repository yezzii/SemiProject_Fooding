    ...
    <section class="container-fluid border-bottom px-0">
      <div class="row no-gutters">
        <div class="col-lg-6 align-self-center px-4 pt-5 pb-4 pb-lg-5">
          <div class="mx-auto text-center text-lg-left" style="max-width: 600px;">
            <h1>How can we help?</h1>
            <h3 class="h6 font-weight-semibold pb-4">Ask Questions. Browse Topics. Find Answers.</h3>
            <div class="input-group mb-3">
              <div class="input-group-prepend"><span class="input-group-text"><i data-feather="search"></i></span></div>
              <input class="form-control form-control-lg" type="text" placeholder="Ask your question...">
            </div>
            <div class="font-size-sm"><span class="text-muted">
                Suggestions:&nbsp;</span><a class="nav-link-inline" href="#">
                Dashboard,&nbsp;</a><a class="nav-link-inline" href="#">
                Payment,&nbsp;</a><a class="nav-link-inline" href="#">
                Refunds,&nbsp;</a><a class="nav-link-inline" href="#">Delivery</a></div>
          </div>
        </div>
        <div class="col-lg-6"><img src="img/pages/help-center.jpg" alt="Help center"></div>
      </div>
    </section>
    <!-- Topics-->
      ...
      <div class="row pt-4">
        <div class="col-sm-6">
          <ul class="list-unstyled">
            <li class="d-flex align-items-center border-bottom pb-3 mb-3"><i class="text-muted mr-2" data-feather="file-text" style="width: 1.2rem; height: 1.2rem;"></i><a class="nav-link-inline" href="#">How long will delivery take?</a></li>
            <li class="d-flex align-items-center border-bottom pb-3 mb-3"><i class="text-muted mr-2" data-feather="file-text" style="width: 1.2rem; height: 1.2rem;"></i><a class="nav-link-inline" href="#">What payment methods do you accept?</a></li>
            <li class="d-flex align-items-center border-bottom pb-3 mb-3"><i class="text-muted mr-2" data-feather="file-text" style="width: 1.2rem; height: 1.2rem;"></i><a class="nav-link-inline" href="#">Do you ship internationally?</a></li>
            <li class="d-flex align-items-center border-bottom pb-3 mb-3"><i class="text-muted mr-2" data-feather="file-text" style="width: 1.2rem; height: 1.2rem;"></i><a class="nav-link-inline" href="#">Do I need an account to place an order?</a></li>
            <li class="d-flex align-items-center border-bottom pb-3 mb-3"><i class="text-muted mr-2" data-feather="file-text" style="width: 1.2rem; height: 1.2rem;"></i><a class="nav-link-inline" href="#">How can I track my order?</a></li>
          </ul>
        </div>
        <div class="col-sm-6">
          <ul class="list-unstyled">
            <li class="d-flex align-items-center border-bottom pb-3 mb-3"><i class="text-muted mr-2" data-feather="file-text" style="width: 1.2rem; height: 1.2rem;"></i><a class="nav-link-inline" href="#">What are the product refund conditions?</a></li>
            <li class="d-flex align-items-center border-bottom pb-3 mb-3"><i class="text-muted mr-2" data-feather="file-text" style="width: 1.2rem; height: 1.2rem;"></i><a class="nav-link-inline" href="#">Do you have discounts for returning customers?</a></li>
            <li class="d-flex align-items-center border-bottom pb-3 mb-3"><i class="text-muted mr-2" data-feather="file-text" style="width: 1.2rem; height: 1.2rem;"></i><a class="nav-link-inline" href="#">How do your referral program work?</a></li>
            <li class="d-flex align-items-center border-bottom pb-3 mb-3"><i class="text-muted mr-2" data-feather="file-text" style="width: 1.2rem; height: 1.2rem;"></i><a class="nav-link-inline" href="#">Where I can view and download invoices for my orders?</a></li>
            <li class="d-flex align-items-center border-bottom pb-3 mb-3"><i class="text-muted mr-2" data-feather="file-text" style="width: 1.2rem; height: 1.2rem;"></i><a class="nav-link-inline" href="#">Do you provide technical support after the purchase?</a></li>
          </ul>
        </div>
      </div>
    </section>
