    ...
    <div class="container pb-5 mt-n2 mt-md-n3">
      <div class="row">
        <div class="col-xl-9 col-md-8">
          <h2 class="h6 d-flex flex-wrap justify-content-between align-items-center px-4 py-3 bg-secondary"><span>Products</span><a class="font-size-sm" href="shop-style1-ls.jsp"><i data-feather="chevron-left" style="width: 1rem; height: 1rem;"></i>Continue shopping</a></h2>
          <!-- Item-->
        ...
        <div class="col-xl-3 col-md-4 pt-3 pt-md-0">
          ...
          <textarea class="form-control mb-3" id="order-comments" rows="5"></textarea><a class="btn btn-primary btn-block" href="checkout-details.jsp"><i class="mr-2" data-feather="credit-card"></i>Proceed to Checkout</a>
          <div class="pt-4">
