...
<html lang="en">
  ...
  <body>
    ...
    <div class="container pb-5 mb-sm-4 mt-n2 mt-md-n3">
      <!-- Steps (wizard)-->
      <div class="steps">
        <div class="steps-body"><a class="step step-completed" href="cart.jsp"><span class="step-indicator"><i data-feather="check"></i></span><span class="step-icon"><i data-feather="shopping-cart"></i></span>1. Shopping cart</a><a class="step step-active" href="checkout-details.jsp"><span class="step-icon"><i data-feather="user"></i></span>2. Your details</a><a class="step" href="checkout-shipping.jsp"><span class="step-icon"><i data-feather="truck"></i></span>3. Shipping</a><a class="step" href="checkout-payment.jsp"><span class="step-icon"><i data-feather="credit-card"></i></span>4. Payment</a><a class="step" href="checkout-review.jsp"><span class="step-icon"><i data-feather="check-circle"></i></span>5. Final review</a></div>
      </div>
      <div class="row pt-4 mt-2">
        <!-- Content-->
        <div class="col-xl-9 col-md-8">
          <div class="d-sm-flex justify-content-between bg-secondary px-4 py-3 mb-4">
            <div class="media"><img class="img-thumbnail rounded-circle mr-3" src="img/account/customer.jpg" width="95" alt="Daniel Adams">
            ...
            <div class="pt-3 pl-sm-2 text-right"><a class="btn btn-light btn-sm" href="account-profile.jsp"><i class="mr-2" data-feather="edit"></i>Edit profile</a></div>
          </div>
          ...
          <div class="d-flex pt-4 mt-3">
            <div class="w-50 pr-3"><a class="btn btn-outline-secondary btn-block" href="cart.jsp"><i class="mr-1" data-feather="chevron-left"></i><span class="d-none d-sm-inline">Back to cart</span><span class="d-inline d-sm-none">Back</span></a></div>
            <div class="w-50 pl-2"><a class="btn btn-primary btn-block" href="checkout-shipping.jsp"><span class="d-none d-sm-inline">Proceed to shipping</span><span class="d-inline d-sm-none">Next</span><i class="ml-1" data-feather="chevron-right"></i></a></div>
          </div>
        </div>
        <!-- Sidebar-->
        <div class="col-xl-3 col-md-4 pt-4 mt-3 pt-md-0 mt-md-0">
          ...
          <div class="font-size-sm border-bottom pt-2 pb-3">
            ...
            <div class="d-flex justify-content-between mb-2"><span>Shipping:</span><span>&mdash;</span></div>
          ...
          <div class="h3 font-weight-semibold text-center py-3">$332.25</div>
          <form class="needs-validation" novalidate>
            <div class="form-group">
