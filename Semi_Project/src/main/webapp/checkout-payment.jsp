...
<html lang="en">
  ...
  <body>
    ...
    <div class="container pb-5 mb-sm-4 mt-n2 mt-md-n3">
      <!-- Steps (wizard)-->
      <div class="steps">
        <div class="steps-body"><a class="step step-completed" href="cart.jsp"><span class="step-indicator"><i data-feather="check"></i></span><span class="step-icon"><i data-feather="shopping-cart"></i></span>1. Shopping cart</a><a class="step step-completed" href="checkout-details.jsp"><span class="step-indicator"><i data-feather="check"></i></span><span class="step-icon"><i data-feather="user"></i></span>2. Your details</a><a class="step step-completed" href="checkout-shipping.jsp"><span class="step-indicator"><i data-feather="check"></i></span><span class="step-icon"><i data-feather="truck"></i></span>3. Shipping</a><a class="step step-active" href="checkout-payment.jsp"><span class="step-icon"><i data-feather="credit-card"></i></span>4. Payment</a><a class="step" href="checkout-review.jsp"><span class="step-icon"><i data-feather="check-circle"></i></span>5. Final review</a></div>
      </div>
      <div class="row pt-4 mt-2">
        <!-- Content-->
        <div class="col-xl-9 col-md-8">
          <h2 class="h6 px-4 py-3 bg-secondary mb-4">Choose payment method</h2>
          <div class="accordion mb-4" id="payment-method" role="tablist">
            <div class="card">
              <div class="card-header" role="tab">
                <h3 class="accordion-heading"><a href="#card" data-toggle="collapse"><i class="mr-2 mt-n1" data-feather="credit-card" style="width: 1.25rem; height: 1.25rem;"></i>Pay with Credit Card<span class="accordion-indicator"><i data-feather="chevron-up"></i></span></a></h3>
              </div>
          ...
          <div class="d-flex pt-2">
            <div class="w-50 pr-3"><a class="btn btn-outline-secondary btn-block" href="checkout-shipping.jsp"><i class="mr-1" data-feather="chevron-left"></i>Back</a></div>
            <div class="w-50 pl-2"><a class="btn btn-primary btn-block" href="checkout-review.jsp"><span class="d-none d-sm-inline">Review your order</span><span class="d-inline d-sm-none">Next</span><i class="ml-1" data-feather="chevron-right"></i></a></div>
          </div>
        </div>
        <!-- Sidebar-->
