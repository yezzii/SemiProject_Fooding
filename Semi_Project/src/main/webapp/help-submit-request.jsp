   ...
   <body>
    ...
    <div class="page-title-wrapper" aria-label="Page title">
      <div class="container">
        ...
        <h1 class="page-title">Submit a request</h1><span class="d-block mt-2 text-muted"></span>
        <hr class="mt-4">
      </div>
    </div>
    <!-- Page Content-->
      ...
      <div class="row">
        <div class="col-xl-3 col-lg-4">
          ...
          <div class="offcanvas-sidebar">
            ...
            <div class="offcanvas-sidebar-body">
              <div class="widget widget-links">
                <h3 class="widget-title">Read this first</h3>
                <ul>
        ...
        <div class="col-xl-9 col-lg-8">
          <div class="alert alert-info alert-with-icon font-size-sm mb-4" role="alert">
            <div class="alert-icon-box"><i class="alert-icon" data-feather="info"></i></div>Our friendly Support team is always here to help you. Begin by selecting a topic we can help you with.
          </div>
          <form class="wizard-body needs-validation" novalidate>
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
            ...
            <button class="btn btn-primary mr-4" type="submit">Submit a request</button><a class="nav-link-inline d-inline-block align-middle font-size-sm py-2" href="#">Privacy policy</a>
          </form>
        </div>
      </div>
    </div>
