...
=======
            <li class="nav-item">
              <a
                ...
                data-toggle="tab"
                role="tab"
                ><i data-feather="log-in"></i>&nbsp;로그인</a
              >
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#signup" data-toggle="tab" role="tab"
                ><i data-feather="user"></i>&nbsp;회원가입</a
              >
            </li>
          </ul>
          <div class="tab-content pt-1">
            <div class="tab-pane fade show active" id="signin" role="tabpanel">
              <form class="needs-validation" novalidate method="post" action="">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="signin-id-icon"
                    ...
                    <input
                      ...
                      aria-label="ID"
                      name = "member_id"
                      aria-describedby="signin-id-icon"
                      required
                    />
...
=======
                ...
                <div class="form-group">
                  <label class="sr-only" for="signup-password-confirm"
                    >비밀번호 확인</label
                  >
                  <input
                    class="form-control"
...
=======
          ...
          <div class="text-center pt-4">
            <a
              class="social-btn sb-facebook mx-2 mb-3"
              href="#"
              data-toggle="tooltip"
              title="Facebook"
      ...
      <div class="offcanvas-body">
        <div class="offcanvas-body-inner">
          <div class="text-right">
            <a class="text-danger btn-sm pr-0" href="#"
              ><i
                class="mr-1"
                data-feather="x"
          ...
          <div class="widget widget-featured-entries pt-3">
              ...
              <div class="featured-entry-thumb mr-3">
                <a href="#"
                  ><img
                    ...
                    width="64"
                    alt="Product thumb" /></a
                ><span class="item-remove-btn"><i data-feather="x"></i></span>
              </div>
              <div class="media-body">
            ...
            <div class="d-flex justify-content-between align-items-center py-3">
              <div class="font-size-sm">
                ...
                ><span class="font-weight-semibold text-dark">$325.00</span>
              </div>
              <a class="btn btn-outline-secondary btn-sm" href="cart.html"
                >Expand cart<i class="mr-n2" data-feather="chevron-right"></i
              ></a>
            </div>
            <a
              class="btn btn-primary btn-sm btn-block"
              href="checkout-details.html"
              ><i class="mr-1" data-feather="credit-card"></i>Checkout</a
            >
          </div>
        </div>
      </div>
    ...
    <header class="navbar navbar-expand-lg navbar-light fixed-top bg-light">
      <div class="container-fluid navbar-inner">
        <!-- navbar brand--><a
          ...
          href="index.html"
          ><img width="100" src="img/logo-dark.png" alt="MStore"
        /></a>
        <!-- navbar collapse area-->
        <div class="collapse navbar-collapse" id="menu">
          <!-- Site menu-->
...
=======
                        <li>
                          <a href="#"
                            ...
                            ></i
                            ><span class="font-size-sm">Clothing</span></a
                          >
                        </li>
                        <li>
                          <a href="#"
                            ><i
                              ...
                              data-feather="chevron-right"
                            ></i
                            ><span class="font-size-sm">Shoes</span></a
                          >
                        </li>
                        <li>
                          <a href="#"
                        ...
                        <li>
                          <a href="#"
                            ><i
                              ...
                              data-feather="chevron-right"
                            ></i
                            ><span class="font-size-sm">Sunglasses</span></a
                          >
                        </li>
                        <li>
                          <a href="#"
                            ><i
                              ...
                              data-feather="chevron-right"
                            ></i
                            ><span class="font-size-sm">Watches</span></a
                          >
                        </li>
                        <li>
                          <a href="#"
                        ...
                        <li>
                          <a href="#"
                            ><i
                              ...
                              data-feather="chevron-right"
                            ></i
                            ><span class="font-size-sm">Headphones</span></a
                          >
                        </li>
                        <li>
                          <a href="#"
                        ...
                        <li>
                          <a href="#"
                            ><i
                              ...
                              data-feather="chevron-right"
                            ></i
                            ><span class="font-size-sm">Lounge Seating</span></a
                          >
                        </li>
                        <li>
                          <a href="#"
                            ><i
                              ...
                              data-feather="chevron-right"
                            ></i
                            ><span class="font-size-sm">File Cabinets</span></a
                          >
                        </li>
                        <li>
                          <a href="#"
                            ><i
                              ...
                              data-feather="chevron-right"
                            ></i
                            ><span class="font-size-sm">Tables</span></a
                          >
                        </li>
                        <li>
                          <a href="#"
                        ...
                        <li>
                          <a href="#"
                            ><i
                              ...
                              data-feather="chevron-right"
                            ></i
                            ><span class="font-size-sm">Office Chairs</span></a
                          >
                        </li>
                        <li>
                          <a href="#"
...
=======
                        <li>
                          <a href="shop-style1-ls.html">
                            ...
                            ><span class="font-size-sm"
                              >Shop Style 1 - Left Sidebar</span
                            ></a
                          >
                        </li>
>>>>>>> origin/test1
...
=======
                        <li>
                          <a href="shop-categories-apparel.html"
                            ...
                            ></i
                            ><span class="font-size-sm"
                              >Shop Categories - Apparel</span
                            ></a
                          >
                        </li>

                        <li>
                          <a href="shop-single-apparel.html"
                            ><i
                              class="widget-categories-indicator"
                              data-feather="chevron-right"
                            ></i
                            ><span class="font-size-sm"
                              >Product Page #1 - Apparel</span
                            ></a
                          >
                        </li>
                        ...
                        <li>
                          <a href="cart.html"
                            ><i
                              ...
                              data-feather="chevron-right"
                            ></i
                            ><span class="font-size-sm">Cart</span></a
                          >
                        </li>
                        <li>
                          <a href="checkout-details.html"
                            ><i
                              class="widget-categories-indicator"
                              data-feather="chevron-right"
                            ></i
                  ...
                  <div class="dropdown-column">
                    <a class="d-block mx-auto" href="#" style="max-width: 228px"
                      ><img
                        class="d-block"
              ...
              <ul class="dropdown-menu">
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="dropdown-divider"></li>
                    <li>
                      <a class="dropdown-item" href="account-tickets.html"
                        >My Tickets</a
                      >
                    </li>
                    <li class="dropdown-divider"></li>
                    <li>
                      <a class="dropdown-item" href="account-single-ticket.html"
                        >Single Ticket</a
                      >
                    </li>
                    <li class="dropdown-divider"></li>
...
=======
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <a class="dropdown-item" href="help-topics.html"
                        >Help Topics</a
                      >
                    </li>
                    <li class="dropdown-divider"></li>
                    <li>
                      <a class="dropdown-item" href="help-single-topic.html"
                        >Single Topic</a
                      >
                    </li>
                    <li class="dropdown-divider"></li>
                    <li>
                      <a class="dropdown-item" href="help-submit-request.html"
                        >Submit a Request</a
                      >
                    </li>
                  </ul>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <a class="dropdown-item" href="blog-rs.html"
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li class="dropdown-divider"></li>
                    <li>
                      <a class="dropdown-item" href="blog-single-ns.html"
                        >Post No Sidebar</a
                      >
                    </li>
>>>>>>> origin/test1
...
=======
            <li class="nav-item dropdown">
              <a
                ...
                href="#"
                data-toggle="dropdown"
                ><i class="mr-1" data-feather="file-text"></i>Docs</a
              >
              <ul class="dropdown-menu">
                <li>
                  <a class="dropdown-item" href="docs/dev-setup.html">
                    <div class="d-flex py-1">
                      ...
                      ></i>
                      <div class="ml-2">
                        <span class="d-block mb-n1">Documentation</span
                ...
                <li class="dropdown-divider"></li>
                <li>
                  <a class="dropdown-item" href="components/alerts.html">
                    <div class="d-flex py-1">
                      <i
                        class="mt-1 ml-n2"
                        data-feather="grid"
                      ...
                      <div class="ml-2">
                        <span class="d-block mb-n1"
                          ...
                          <span class="badge badge-pill badge-success"
                            >40+</span
                          ></span
                        ><small class="text-muted">Faster page building</small>
                      </div>
                    </div></a
                  >
                </li>
                ...
                <li>
                  <a class="dropdown-item" href="mailto:contact@createx.studio">
                    <div class="d-flex py-1">
                      ...
                      ></i>
                      <div class="ml-2">
                        <span class="d-block mb-n1">Support</span
                        ><small class="text-muted"
                          >contact@createx.studio</small
                        >
                      </div>
                    </div></a
                  >
...
=======
            ...
            <a
              ...
              ><i class="mx-auto mb-1" data-feather="search"></i>Search</a
            ><a
              class="navbar-btn navbar-collapse-hidden"
          ...
          <div class="mx-auto bg-light my-sm-4" style="max-width: 37rem">
            ...
            >
              <div class="py-5 px-3 px-sm-5">
                <img
                  class="d-block mb-2"
                  src="img/home/apparel/hero-slide-logo01.png"
                  width="180"
                  alt="Reebok"
                />
                <h2 class="mb-1">Sneakers Classic Collection</h2>
                <h3 class="font-weight-light opacity-70 pb-3">
                  starting at $105.99
                </h3>
              ...
              <div class="py-5 px-3 px-sm-5">
                <img
                  class="d-block mb-2"
                  src="img/home/apparel/hero-slide-logo02.png"
                  width="129"
                  alt="The North Face"
                />
                <h2 class="mb-1">Sports Hoodie Collection</h2>
              ...
              <div class="py-5 px-3 px-sm-5">
                <img
                  class="d-block mb-2"
                  src="img/home/apparel/hero-slide-logo03.png"
                  width="182"
                  alt="Calvin Klein"
                />
                <h2 class="mb-1">Sunglasses Collection</h2>
...
=======
          ...
          >
            <img
              class="ml-auto mr-0"
              src="img/home/apparel/hero-slide01.jpg"
              alt="Sneakers Collection"
            /><img
              class="ml-auto mr-0"
              src="img/home/apparel/hero-slide02.jpg"
              alt="Hoodie Collection"
            /><img
              class="ml-auto mr-0"
              src="img/home/apparel/hero-slide03.jpg"
      ...
      >
        <div class="card border-0">
          <a class="card-img-tiles" href="shop-style1-ls.html">
            ...
            <div class="thumblist">
              <img
                src="img/shop/apparel/categories/02.jpg"
                alt="Clothing"
              /><img
                src="img/shop/apparel/categories/03.jpg"
                alt="Clothing"
              /></div
          ></a>
          <div class="card-body border mt-n1 py-4 text-center">
          ...
          <a class="card-img-tiles" href="shop-style1-ls.html">
            ...
            <div class="thumblist">
              <img src="img/shop/apparel/categories/05.jpg" alt="Shoes" /><img
                src="img/shop/apparel/categories/06.jpg"
                alt="Shoes"
              /></div
          ></a>
          <div class="card-body border mt-n1 py-4 text-center">
            ...
            <span class="d-block mb-3 font-size-xs text-muted"
              >Starting from
              <span class="font-weight-semibold">$56.00</span></span
            ><a
              class="btn btn-pill btn-outline-primary btn-sm"
              href="shop-style1-ls.html"
              >Shop shoes</a
          ...
          <a class="card-img-tiles" href="shop-style1-ls.html">
            ...
            <div class="thumblist">
              <img src="img/shop/apparel/categories/08.jpg" alt="Bags" /><img
                src="img/shop/apparel/categories/09.jpg"
                alt="Bags"
              /></div
          ></a>
          <div class="card-body border mt-n1 py-4 text-center">
            ...
            <span class="d-block mb-3 font-size-xs text-muted"
              >Starting from
              <span class="font-weight-semibold">$27.00</span></span
            ><a
              class="btn btn-pill btn-outline-primary btn-sm"
              href="shop-style1-ls.html"
              >Shop bags</a
...
=======
      ...
      >
        <a class="d-block bg-white border py-3 py-sm-4" href="#"
          ><img
            ...
            src="img/shop/apparel/brands/01.png"
            style="width: 150px"
            alt="Brand" /></a
        ><a class="d-block bg-white border py-3 py-sm-4" href="#"
          ><img
            class="d-block mx-auto"
            src="img/shop/apparel/brands/02.png"
            style="width: 150px"
            alt="Brand" /></a
        ><a class="d-block bg-white border py-3 py-sm-4" href="#"
          ><img
            class="d-block mx-auto"
            src="img/shop/apparel/brands/03.png"
            style="width: 150px"
            alt="Brand" /></a
        ><a class="d-block bg-white border py-3 py-sm-4" href="#"
          ><img
            class="d-block mx-auto"
            src="img/shop/apparel/brands/04.png"
            style="width: 150px"
            alt="Brand" /></a
        ><a class="d-block bg-white border py-3 py-sm-4" href="#"
          ><img
            class="d-block mx-auto"
            src="img/shop/apparel/brands/05.png"
            style="width: 150px"
            alt="Brand" /></a
        ><a class="d-block bg-white border py-3 py-sm-4" href="#"
          ><img
            class="d-block mx-auto"
            src="img/shop/apparel/brands/06.png"
            style="width: 150px"
            alt="Brand" /></a
        ><a class="d-block bg-white border py-3 py-sm-4" href="#"
          ><img
            class="d-block mx-auto"
            src="img/shop/apparel/brands/07.png"
            style="width: 150px"
            alt="Brand" /></a
        ><a class="d-block bg-white border py-3 py-sm-4" href="#"
          ><img
            class="d-block mx-auto"
            src="img/shop/apparel/brands/08.png"
            style="width: 150px"
            alt="Brand" /></a
        ><a class="d-block bg-white border py-3 py-sm-4" href="#"
          ><img
            class="d-block mx-auto"
            src="img/shop/apparel/brands/09.png"
            style="width: 150px"
            alt="Brand" /></a
        ><a class="d-block bg-white border py-3 py-sm-4" href="#"
          ><img
            class="d-block mx-auto"
            src="img/shop/apparel/brands/10.png"
            style="width: 150px"
            alt="Brand" /></a
        ><a class="d-block bg-white border py-3 py-sm-4" href="#"
          ><img
            class="d-block mx-auto"
            src="img/shop/apparel/brands/11.png"
            style="width: 150px"
            alt="Brand" /></a
        ><a class="d-block bg-white border py-3 py-sm-4" href="#"
          ><img
            class="d-block mx-auto"
            src="img/shop/apparel/brands/12.png"
            style="width: 150px"
            alt="Brand"
        /></a>
      </div>
    ...
    <section class="container-fluid mb-5 mt-4">
      <div
        class="bg-size-cover bg-position-center py-5"
...
=======
            <div class="product-thumb">
              ...
              ><img src="img/shop/apparel/01.jpg" alt="Product" />
            </div>
...
=======
            <div class="product-thumb">
              ...
              ><span
                ...
                title="Add to wishlist"
                ><i data-feather="heart"></i></span
              ><img src="img/shop/apparel/04.jpg" alt="Product" />
            </div>
            <div class="product-card-body text-center">
              ...
              <div class="pb-2 text-center">
                ...
                >
                  <input
                    ...
                    id="red-2"
                  />
                  <label class="custom-option-label" for="red-2"
                    ><span
                      class="custom-option-color"
                      style="background-color: #c53b4b"
                    ></span
                  ></label>
                </div>
                <div
                ...
                >
                  <input
                    ...
                    checked
                  />
                  <label class="custom-option-label" for="blue-2"
                    ><span
                      class="custom-option-color"
                      style="background-color: #4e5392"
                    ></span
                  ></label>
                </div>
                <div
                ...
                >
                  <input
                    ...
                    id="white-2"
                  />
                  <label class="custom-option-label" for="white-2"
                    ><span
                      class="custom-option-color"
...
=======
            <div class="product-thumb">
              ...
              ><span
                ...
                title="Add to wishlist"
                ><i data-feather="heart"></i></span
              ><img src="img/shop/apparel/03.jpg" alt="Product" />
            </div>
            <div class="product-card-body text-center">
...
=======
            <div class="product-thumb">
              ...
              ><span
                ...
                title="Add to wishlist"
                ><i data-feather="heart"></i></span
              ><img src="img/shop/apparel/06.jpg" alt="Product" />
            </div>
            <div class="product-card-body text-center">
              <a class="product-meta" href="#">Sunglasses</a>
              <h3 class="product-card-title">
                <a href="shop-single-apparel.html"
                  >Medicine Chameleon Sunglasses</a
                >
              </h3>
              ...
              <div class="pb-2 text-center">
                ...
                >
                  <input
                    ...
                    checked
                  />
                  <label class="custom-option-label" for="brown-3"
                    ><span
                      class="custom-option-color"
                      style="background-color: #ba7764"
                    ></span
                  ></label>
                </div>
                <div
                ...
                >
                  <input
                    ...
                    id="black-3"
                  />
                  <label class="custom-option-label" for="black-3"
                    ><span
                      class="custom-option-color"
...
=======
            <div class="product-thumb">
              ...
              ><span
                ...
                title="Add to wishlist"
                ><i data-feather="heart"></i></span
              ><img src="img/shop/apparel/08.jpg" alt="Product" />
            </div>
            <div class="product-card-body text-center">
              <a class="product-meta" href="#">Women's sneakers</a>
              <h3 class="product-card-title">
                <a href="shop-single-apparel.html"
                  >Reebok Classic Sneakers Pyro</a
                >
              </h3>
...
=======
            <div class="product-thumb">
              ...
              ><span
                ...
                title="Add to wishlist"
                ><i data-feather="heart"></i></span
              ><img src="img/shop/apparel/07.jpg" alt="Product" />
            </div>
            <div class="product-card-body text-center">
...
=======
            <div class="product-thumb">
              ...
              ><span
                ...
                title="Add to wishlist"
                ><i data-feather="heart"></i></span
              ><img src="img/shop/apparel/09.jpg" alt="Product" />
            </div>
            <div class="product-card-body text-center">
              ...
              <div class="pb-2 text-center">
                ...
                >
                  <input
                    ...
                    id="cyan-4"
                  />
                  <label class="custom-option-label" for="cyan-4"
                    ><span
                      class="custom-option-color"
                      style="background-color: #8ab5be"
                    ></span
                  ></label>
                </div>
                <div
                ...
                >
                  <input
                    ...
                    checked
                  />
                  <label class="custom-option-label" for="blue-4"
                    ><span
                      class="custom-option-color"
                      style="background-color: #4e5392"
                    ></span
                ...
                >
                  <input
                    ...
                    id="beige-4"
                  />
                  <label class="custom-option-label" for="beige-4"
                    ><span
                      class="custom-option-color"
                      style="background-color: #fccec2"
                    ></span
                  ></label>
                </div>
              </div>
...
=======
            <div class="product-thumb">
              ...
              ><span
                ...
                title="Add to wishlist"
                ><i data-feather="heart"></i></span
              ><img src="img/shop/apparel/11.jpg" alt="Product" />
            </div>
            <div class="product-card-body text-center">
              <a class="product-meta" href="#">Men's tshirts</a>
              <h3 class="product-card-title">
                <a href="shop-single-apparel.html"
                  >Medicine Tshirt Sailor Spirit</a
                >
              </h3>
...
=======
        <div class="col-md-6 py-5 px-4" style="background-color: #efefef">
          <div class="mx-auto py-3" style="max-width: 25rem">
            ...
            <a class="btn btn-outline-dark" href="blog-ls.html"
...
=======
                ...
                >
                  <img src="img/shop/apparel/single/01.jpg" alt="Product" /><img
                    src="img/shop/apparel/single/02.jpg"
                    alt="Product"
                  /><img
                    src="img/shop/apparel/single/03.jpg"
                    alt="Product"
                  /><img
                    src="img/shop/apparel/single/04.jpg"
                    alt="Product"
...
=======
                    ...
                    >
                      <input
                        ...
                        required
                      />
                      <label class="custom-option-label" for="red"
                        ><span
                          class="custom-option-color"
                          style="background-color: #e7484d"
                        ></span
                      ></label>
                    </div>
                    <div
                    ...
                    >
                      <input
                        ...
                        required
                      />
                      <label class="custom-option-label" for="white"
                        ><span
                          class="custom-option-color"
                          style="background-color: #e0dfe4"
                        ></span
                      ></label>
                    </div>
                    <div
                    ...
                    >
                      <input
                        ...
                        required
                      />
                      <label class="custom-option-label" for="beige"
                        ><span
                          class="custom-option-color"
                          style="background-color: #e6ddd6"
                        ></span
                      ></label>
                    </div>
                  </div>
...
=======
                    ...
                    <div>
                      <button class="btn btn-primary px-5 mr-2" type="submit">
                        <i class="mr-2" data-feather="shopping-cart"></i>Add to
                        cart
                      </button>
                    </div>
...
=======
      ...
      >
        <div class="toast-header bg-success text-white">
          ...
          ></i
          ><span class="font-weight-semibold mr-auto">Added to cart!</span>
          <button
      ...
      >
        <div class="toast-header bg-info text-white">
          <i
            ...
            style="width: 1.25rem; height: 1.25rem"
          ></i
          ><span class="font-weight-semibold mr-auto"
            >Added to comparison!</span
          >
          <button
            class="close text-white ml-2 mb-1"
            type="button"
      ...
      >
        <div class="toast-header bg-info text-white">
          <i
            ...
            style="width: 1.25rem; height: 1.25rem"
          ></i
          ><span class="font-weight-semibold mr-auto">Added to wishlist!</span>
          <button
            class="close text-white ml-2 mb-1"
            type="button"
            data-dismiss="toast"
      ...
      >
        <div class="toast-header bg-success text-white">
          <i
            ...
            style="width: 1.25rem; height: 1.25rem"
          ></i
          ><span class="font-weight-semibold mr-auto">Updated!</span>
          <button
            class="close text-white ml-2 mb-1"
            type="button"
            data-dismiss="toast"
                  ...
                  <li>
                    <a class="nav-link-inline nav-link-light" href="#"
                      ><i
                        ...
                        data-feather="chevron-right"
                      ></i
                      ><span class="font-size-sm">Apparel &amp; Shoes</span></a
                    >
                  </li>
                  <li>
                    <a class="nav-link-inline nav-link-light" href="#"
                  ...
                  <li>
                    <a class="nav-link-inline nav-link-light" href="#"
                      ><i
                        ...
                        data-feather="chevron-right"
                      ></i
                      ><span class="font-size-sm">Wearable Electronics</span></a
                    >
                  </li>
                  <li>
                    <a class="nav-link-inline nav-link-light" href="#"
                      ><i
                        ...
                        data-feather="chevron-right"
                      ></i
                      ><span class="font-size-sm">Printers &amp; Ink</span></a
                    >
                  </li>
                  <li>
                    <a class="nav-link-inline nav-link-light" href="#"
                  ...
                  <li>
                    <a class="nav-link-inline nav-link-light" href="#"
                      ><i
                        ...
                        data-feather="chevron-right"
                      ></i
                      ><span class="font-size-sm">Car Electronics</span></a
                    >
                  </li>
                  <li>
                    <a class="nav-link-inline nav-link-light" href="#"
                  ...
                  <li>
                    <a class="nav-link-inline nav-link-light" href="#"
                      ><i
                        ...
                        data-feather="chevron-right"
                      ></i
                      ><span class="font-size-sm">Your account</span></a
                    >
                  </li>
                  <li>
                    <a class="nav-link-inline nav-link-light" href="#"
                  ...
                  <li>
                    <a class="nav-link-inline nav-link-light" href="#"
                      ><i
                        ...
                        data-feather="chevron-right"
                      ></i
                      ><span class="font-size-sm">Taxes</span></a
                    >
                  </li>
                  <li>
                    <a class="nav-link-inline nav-link-light" href="#"
                  ...
                  <li>
                    <a class="nav-link-inline nav-link-light" href="#"
                      ><i
                        ...
                        data-feather="chevron-right"
                      ></i
                      ><span class="font-size-sm">Careers</span></a
                    >
                  </li>
                  <li>
                    <a class="nav-link-inline nav-link-light" href="#"
                      ><i
                        ...
                        data-feather="chevron-right"
                      ></i
                      ><span class="font-size-sm">About shop</span></a
                    >
                  </li>
                  <li>
                    <a class="nav-link-inline nav-link-light" href="#"
                      ><i
                        ...
                        data-feather="chevron-right"
                      ></i
                      ><span class="font-size-sm">Our stores</span></a
                    >
                  </li>
                  <li>
                    <a class="nav-link-inline nav-link-light" href="#"
                      ><i
                        ...
                        data-feather="chevron-right"
                      ></i
                      ><span class="font-size-sm">Services</span></a
                    >
                  </li>
                  <li>
                    <a class="nav-link-inline nav-link-light" href="#"
...
=======
                ...
                >
                  ...
                  <p
                    class="font-size-xs text-white opacity-60 pt-2 mb-2"
                    id="mc-helper"
                  >
...
=======
                  ...
                  <a
                    class="market-btn market-btn-light apple-btn mr-2 mb-2"
                    href="#"
                    role="button"
                    ><span class="market-button-subtitle">Download on the</span
                    ><span class="market-button-title">App Store</span></a
                  ><a
                    class="market-btn market-btn-light google-btn"
                    href="#"
                    role="button"
                    ><span class="market-button-subtitle">Download on the</span
            ...
            <div class="col-sm-6 text-center text-sm-left">
              <div class="mb-4 mb-sm-0">
                <a class="d-inline-block" href="index.html"
                  ><img width="100" src="img/logo-light.png" alt="MStore"
                /></a>
              </div>
            </div>
            <div class="col-sm-6 text-center text-sm-right">
              <a class="social-btn sb-facebook sb-light mx-1 mb-2" href="#"
                ><i class="flaticon-facebook"></i></a
              ><a class="social-btn sb-twitter sb-light mx-1 mb-2" href="#"
                ><i class="flaticon-twitter"></i></a
              ><a class="social-btn sb-instagram sb-light mx-1 mb-2" href="#"
                ><i class="flaticon-instagram"></i></a
              ><a class="social-btn sb-vimeo sb-light mx-1 mb-2" href="#"
...
=======
                ...
                <li class="list-inline-item mr-3">
                  <a class="nav-link-inline nav-link-light" href="#">Support</a>
                </li>
                <li class="list-inline-item mr-3">
                  <a class="nav-link-inline nav-link-light" href="#">Privacy</a>
                </li>
                <li class="list-inline-item mr-3">
                  <a class="nav-link-inline nav-link-light" href="#"
                    >Terms of use</a
			...
			<div class="offcanvas-body-inner">
				<ul class="nav nav-tabs nav-justified" role="tablist">
					<li class="nav-item"><a class="nav-link active" href="#signin"
						data-toggle="tab" role="tab"><i data-feather="log-in"></i>&nbsp;Sign
							In</a></li>
					<li class="nav-item"><a class="nav-link" href="#signup"
						data-toggle="tab" role="tab"><i data-feather="user"></i>&nbsp;Sign
							Up</a></li>
				</ul>
				<div class="tab-content pt-1">
					<div class="tab-pane fade show active" id="signin" role="tabpanel">
						<form class="needs-validation" novalidate>
							<div class="form-group">
								...
								<div class="input-group">
									<div class="input-group-prepend">
										<span class="input-group-text" id="signin-email-icon"><i
											data-feather="mail"></i></span>
									</div>
									<input class="form-control" type="email" id="signin-email"
										placeholder="Email" aria-label="Email"
										aria-describedby="signin-email-icon" required>
									<div class="invalid-feedback">Please provide email
										address.</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input class="form-control" type="password"
										...
										aria-label="Password" aria-describedby="signin-password-icon"
										required>
									<div class="invalid-feedback">Please enter a password.</div>
								</div>
							</div>
					...
					<div class="tab-pane fade" id="signup" role="tabpanel">
						<form class="needs-validation" novalidate>
							...
							<div class="form-group">
								<label class="sr-only" for="signup-password-confirm">Confirm
				...
				<div class="d-flex align-items-center pt-5">
					<hr class="w-100">
					<div class="px-3 w-100 text-nowrap font-weight-semibold">Or
						sign in via</div>
					<hr class="w-100">
				</div>
				<div class="text-center pt-4">
			...
			<div class="offcanvas-body-inner">
				<div class="text-right">
					<a class="text-danger btn-sm pr-0" href="#"><i class="mr-1"
						data-feather="x" style="width: .85rem; height: .85rem;"></i>Clear
						cart</a>
				</div>
				<div class="widget widget-featured-entries pt-3">
					<div class="media">
			...
			<div class="collapse navbar-collapse" id="menu">
				...
				<div class="navbar-lang-switcher dropdown pr-2">
					...
					<ul class="dropdown-menu">
						...
						<li><a class="dropdown-item" href="#"><img class="mr-2"
								width="20" src="img/flags/de.png" alt="Deutsch" />Deutsch</a></li>
						<li class="dropdown-divider"></li>
						<li><a class="dropdown-item" href="#"><img class="mr-2"
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item dropdown mega-dropdown active"><a
						class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">Home</a>
						<div class="dropdown-menu">
							<div class="dropdown-inner">
								<a class="dropdown-column text-decoration-0"
									href="home-apparel.html"><img
									class="d-block img-thumbnail mb-2"
									src="img/megamenu/home-apparel.jpg" alt="Home Apparel Shop">
									<div class="text-center font-weight-semibold text-dark">Home
										Apparel Shop</div></a><a class="dropdown-column text-decoration-0"
									href="home-electronics.html"><img
									class="d-block img-thumbnail mb-2"
									src="img/megamenu/home-electronics.jpg"
									alt="Home Electronics Store">
									<div class="text-center font-weight-semibold text-dark">Home
										Electronics Store</div></a>
							</div>
						</div></li>
										...
										<ul>
											<li><a href="shop-style1-ls.html"><i
													...
													data-feather="chevron-right"></i><span class="font-size-sm">Shop
														Style 1 - Left Sidebar</span></a></li>
											<li><a href="shop-style1-rs.html"><i
													class="widget-categories-indicator"
													data-feather="chevron-right"></i><span class="font-size-sm">Shop
														Style 1 - Right Sidebar</span></a></li>
											<li><a href="shop-style1-ft.html"><i
													class="widget-categories-indicator"
													data-feather="chevron-right"></i><span class="font-size-sm">Shop
														Style 1 - Filters Top</span></a></li>
											<li><a href="shop-style2-ls.html"><i
													class="widget-categories-indicator"
													data-feather="chevron-right"></i><span class="font-size-sm">Shop
														Style 2 - Left Sidebar</span></a></li>
											<li><a href="shop-style2-rs.html"><i
													class="widget-categories-indicator"
													data-feather="chevron-right"></i><span class="font-size-sm">Shop
														Style 2 - Right Sidebar</span></a></li>
											<li><a href="shop-style2-ft.html"><i
													class="widget-categories-indicator"
													data-feather="chevron-right"></i><span class="font-size-sm">Shop
														Style 2 - Filters Top</span></a></li>
										</ul>
									</div>
								</div>
								<div class="dropdown-column">
									<div class="widget widget-links">
										...
										<ul>
											...
											<li><a href="shop-categories-electronics.html"><i
													class="widget-categories-indicator"
													data-feather="chevron-right"></i><span class="font-size-sm">Shop
														Categories - Electronics</span></a></li>
							...
							<li class="dropdown"><a
								...
								<ul class="dropdown-menu">
									<li><a class="dropdown-item" href="blog-rs.html">Blog
											Right Sidebar</a></li>
									<li class="dropdown-divider"></li>
									<li><a class="dropdown-item" href="blog-ls.html">Blog
											Left Sidebar</a></li>
									<li class="dropdown-divider"></li>
									<li><a class="dropdown-item" href="blog-ns.html">Blog
											No Sidebar</a></li>
								</ul></li>
							<li class="dropdown-divider"></li>
							<li class="dropdown"><a
								...
								<ul class="dropdown-menu">
									<li><a class="dropdown-item" href="blog-single-rs.html">Post
											Right Sidebar</a></li>
									<li class="dropdown-divider"></li>
									<li><a class="dropdown-item" href="blog-single-ls.html">Post
											Left Sidebar</a></li>
									<li class="dropdown-divider"></li>
									...
									<div class="d-flex py-1">
										...
										<div class="ml-2">
											<span class="d-block mb-n1">Components <span
												...
												class="text-muted">Faster page building</small>
										</div>
									</div>
							</a></li>
							<li class="dropdown-divider"></li>
									...
									<div class="d-flex py-1">
										...
										<div class="ml-2">
											<span class="d-block mb-n1">Changelog <span
												...
												class="text-muted">Regular updates</small>
										</div>
									</div>
							</a></li>
							<li class="dropdown-divider"></li>
			...
			<div class="navbar-btns">
				<div class="navbar-btns-inner">
					...
					<a class="navbar-btn" href="#offcanvas-search"
						...
						class="mx-auto mb-1" data-feather="log-in"></i>Sign In/Up</a><a
						...
						<div class="pb-2 text-center">
							<div
								...
								<input class="custom-control-input" type="radio" name="size-1"
									id="xl-1"> <label class="custom-option-label"
									for="xl-1">XL</label>
							</div>
							<div
								class="custom-control custom-option custom-control-inline mb-2">
							...
							<div
								class="custom-control custom-option custom-control-inline mb-2">
								<input class="custom-control-input" type="radio" name="size-1"
									id="xs-1"> <label class="custom-option-label"
									for="xs-1">XS</label>
							</div>
						</div>
						...
						<div class="pb-2 text-center">
							<div
								...
								<input class="custom-control-input" type="radio" name="color-2"
									id="red-2"> <label class="custom-option-label"
									for="red-2"><span class="custom-option-color"
									style="background-color: #c53b4b;"></span></label>
							</div>
							<div
								class="custom-control custom-option custom-control-inline mb-2">
								<input class="custom-control-input" type="radio" name="color-2"
						...
						<div class="pb-2 text-center">
							<div
								...
								<input class="custom-control-input" type="radio" name="size-2"
									id="s-10"> <label class="custom-option-label"
									for="s-10">10</label>
							</div>
							<div
								class="custom-control custom-option custom-control-inline mb-2">
							...
							<div
								class="custom-control custom-option custom-control-inline mb-2">
								<input class="custom-control-input" type="radio" name="size-2"
									id="s-85"> <label class="custom-option-label"
									for="s-85">8.5</label>
							</div>
							<div
								class="custom-control custom-option custom-control-inline mb-2">
						...
						<div class="pb-2 text-center">
							<div
								...
								<input class="custom-control-input" type="radio" name="color-3"
									id="brown-3" checked> <label
									class="custom-option-label" for="brown-3"><span
									class="custom-option-color" style="background-color: #ba7764;"></span></label>
							</div>
							<div
								class="custom-control custom-option custom-control-inline mb-2">
								<input class="custom-control-input" type="radio" name="color-3"
						...
						<div class="pb-2 text-center">
							<div
								...
								<input class="custom-control-input" type="radio" name="size-5"
									id="s-5-95"> <label class="custom-option-label"
									for="s-5-95">9.5</label>
							</div>
							<div
								class="custom-control custom-option custom-control-inline mb-2">
								<input class="custom-control-input" type="radio" name="size-5"
							...
							<div
								class="custom-control custom-option custom-control-inline mb-2">
								<input class="custom-control-input" type="radio" name="size-5"
									id="s-5-85"> <label class="custom-option-label"
									for="s-5-85">8.5</label>
							</div>
							<div
								class="custom-control custom-option custom-control-inline mb-2">
								<input class="custom-control-input" type="radio" name="size-5"
									id="s-5-8"> <label class="custom-option-label"
									for="s-5-8">8</label>
							</div>
							<div
								class="custom-control custom-option custom-control-inline mb-2">
								<input class="custom-control-input" type="radio" name="size-5"
									id="s-5-75"> <label class="custom-option-label"
									for="s-5-75">7.5</label>
							</div>
						</div>
						<button class="btn btn-primary btn-sm btn-block" type="button"
							data-toggle="toast" data-target="#cart-toast">Add to
					...
					<div class="product-card-body body-hidden">
						<div class="pb-2 text-center">
							...
							<div
								class="custom-control custom-option custom-control-inline mb-2">
								<input class="custom-control-input" type="radio" name="size-4"
									id="xs-4"> <label class="custom-option-label"
									for="xs-4">XS</label>
							</div>
						</div>
						<button class="btn btn-primary btn-sm btn-block" type="button"
						...
						<div class="pb-2 text-center">
							<div
								...
								<input class="custom-control-input" type="radio" name="color-4"
									id="cyan-4"> <label class="custom-option-label"
									for="cyan-4"><span class="custom-option-color"
									style="background-color: #8ab5be;"></span></label>
							</div>
							<div
								class="custom-control custom-option custom-control-inline mb-2">
								<input class="custom-control-input" type="radio" name="color-4"
						...
						<div class="pb-2 text-center">
							<div
								...
								<input class="custom-control-input" type="radio" name="size-7"
									id="xl-7"> <label class="custom-option-label"
									for="xl-7">XL</label>
							</div>
							<div
								class="custom-control custom-option custom-control-inline mb-2">
							...
							<div
								class="custom-control custom-option custom-control-inline mb-2">
								<input class="custom-control-input" type="radio" name="size-7"
									id="xs-7"> <label class="custom-option-label"
									for="xs-7">XS</label>
							</div>
						</div>
						<button class="btn btn-primary btn-sm btn-block" type="button"
