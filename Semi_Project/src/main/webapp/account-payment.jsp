          ...
          <ul class="nav nav-tabs d-none d-sm-flex">
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle active" href="#" data-toggle="dropdown"><i data-feather="settings"></i>&nbsp;Account settings</a>
              <div class="dropdown-menu"><a class="dropdown-item" href="account-profile.html">Profile info</a>
                ...
                <div class="dropdown-divider"></div><a class="dropdown-item active" href="account-payment.html">Payment methods</a>
              </div>
            </li>
          </ul>
            ...
            <table class="table table-hover mb-0">
              ...
              <tbody>
                <tr>
                  <td class="align-middle">
                    <div class="media align-items-center"><img class="mr-2" src="img/card-visa.png" width="39" alt="Visa">
                      <div class="media-body"><strong class="mr-1">Visa</strong>ending in 4999<span class="align-middle badge badge-info ml-2">Primary</span></div>
                    </div>
                  </td>
                  <td class="align-middle">Daniel Adams</td>
                  <td class="align-middle">08 / 2019</td>
                  <td class="align-middle"><a class="nav-link-inline mr-2" href="#" data-toggle="tooltip" title="Edit"><i data-feather="edit-2" style="width: 1rem; height: 1rem;"></i></a><a class="nav-link-inline text-danger" href="#" data-toggle="tooltip" title="Remove"><i data-feather="x" style="width: 1rem; height: 1rem;"></i></a></td>
                </tr>
                <tr>
                  <td class="align-middle">
                    <div class="media align-items-center"><img class="mr-2" src="img/card-master.png" width="39" alt="Visa">
                      <div class="media-body"><strong class="mr-1">MasterCard</strong>ending in 0015</div>
                    </div>
                  </td>
                  <td class="align-middle">Daniel Adams</td>
                  <td class="align-middle">11 / 2021</td>
                  <td class="align-middle"><a class="nav-link-inline mr-2" href="#" data-toggle="tooltip" title="Edit"><i data-feather="edit-2" style="width: 1rem; height: 1rem;"></i></a><a class="nav-link-inline text-danger" href="#" data-toggle="tooltip" title="Remove"><i data-feather="x" style="width: 1rem; height: 1rem;"></i></a></td>
                </tr>
                <tr>
                  <td class="align-middle">
                    <div class="media align-items-center"><img class="mr-2" src="img/card-paypal.png" width="39" alt="Visa">
                      <div class="media-body"><strong class="mr-1">PayPal</strong>d.adams@example.com</div>
                    </div>
                  </td>
                ...
                <tr>
                  <td class="align-middle">
                    <div class="media align-items-center"><img class="mr-2" src="img/card-visa.png" width="39" alt="Visa">
                      <div class="media-body"><strong class="mr-1">Visa</strong>ending in 6073</div>
                    </div>
                  </td>
                  <td class="align-middle">Daniel Adams</td>
                  <td class="align-middle">09 / 2021</td>
                  <td class="align-middle"><a class="nav-link-inline mr-2" href="#" data-toggle="tooltip" title="Edit"><i data-feather="edit-2" style="width: 1rem; height: 1rem;"></i></a><a class="nav-link-inline text-danger" href="#" data-toggle="tooltip" title="Remove"><i data-feather="x" style="width: 1rem; height: 1rem;"></i></a></td>
                </tr>
                <tr>
                  <td class="align-middle">
                    <div class="media align-items-center"><img class="mr-2" src="img/card-visa.png" width="39" alt="Visa">
                      <div class="media-body"><strong class="mr-1">Visa</strong>ending in 9791</div>
                    </div>
                  </td>
                  <td class="align-middle">Daniel Adams</td>
                  <td class="align-middle">05 / 2021</td>
                  <td class="align-middle"><a class="nav-link-inline mr-2" href="#" data-toggle="tooltip" title="Edit"><i data-feather="edit-2" style="width: 1rem; height: 1rem;"></i></a><a class="nav-link-inline text-danger" href="#" data-toggle="tooltip" title="Remove"><i data-feather="x" style="width: 1rem; height: 1rem;"></i></a></td>
                </tr>
              </tbody>
            </table>
