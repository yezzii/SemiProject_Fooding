...
<body>
	...
	<div class="page-title-wrapper" aria-label="Page title">
		<div class="container">
			...
			<div class="post-meta">
				<div>
					<a href="#">Fooding, &nbsp;</a><a href="#">Board</a><span
						class="meta-divider"></span><a href="#">#yummy!</a>
				</div>
			</div>
		</div>
	</div>
							...
							<c:if test="${!empty list }">
								<c:forEach items="${list}" var="dto">
									<tr>
										...
										<td><a
											href="<%=request.getContextPath()%>/content_board.do?no=${dto.getBoard_idx() }">${dto.getBoard_title() }</a></td>
					...
					<div class="offcanvas-sidebar-body">
						<div class="offcanvas-sidebar-body-inner">
							...
							<div class="widget widget-categories mb-4 py-1">
								...
								<ul>
									<li><a href="food_magazine.jsp"><i
											class="widget-categories-indicator"
											data-feather="chevron-right"></i>매거진<span
											class="badge text-muted ml-1">(5)</span></a></li>
									<li><a href="food_column.jsp"><i
											class="widget-categories-indicator"
											data-feather="chevron-right"></i>음식 컬럼<span
											class="badge text-muted ml-1">(5)</span></a></li>
								</ul>
							</div>
							...
							<div class="widget mb-4 pb-1">
								...
								<a class="tag-link mr-2 mb-2" href="#">#오마카세</a><a
									class="tag-link mr-2 mb-2" href="#">#삼겹살</a><a
									class="tag-link mr-2 mb-2" href="#">#한우</a><a
									class="tag-link mr-2 mb-2" href="#">#짜장면</a><a
									class="tag-link mb-2" href="#">#스시</a>
							</div>
						</div>
					</div>
				</div>
		...
		<nav aria-label="Page navigation">
			<ul
				...
				<li class="page-item"><a class="page-link"
					href="free_board.do?page=1">처음</a></li>
				<li class="page-item"><a class="page-link"
					href="free_board.do?page=${page - 1 }">이전</a></li>

				<c:forEach begin="${startBlock }" end="${endBlock }" var="i">
					<c:if test="${i == page }">
						<li class="page-item active" aria-current="page"><a
							class="page-link" href="free_board.do?page=${i }">${i }</a></li>
					</c:if>

					<c:if test="${i != page }">
						<li class="page-item"><a class="page-link"
							href="free_board.do?page=${i }">${i }</a></li>
					</c:if>
				</c:forEach>
				...
				<c:if test="${endBlock < allPage }">
					<li class="page-item"><a class="page-link"
						href="free_board.do?page=${page + 1 }">다음</a></li>

					<li class="page-item"><a class="page-link"
						href="free_board.do?page=${allPage }">마지막</a></li>
				</c:if>
