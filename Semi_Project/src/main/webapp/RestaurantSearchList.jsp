	...
	<div class="container pb-5 mb-4">
		...
		<nav aria-label="Page navigation">
			<ul class="pagination justify-content-center justify-content-sm-center mb-0">
				...
				<li class="page-item"><a class="page-link"
					href="total_main_search.do?page=${page - 1 }&keyword=${keyword }">이전</a></li>

				<c:forEach begin="${startBlock }" end="${endBlock }" var="i">
					<c:if test="${i == page }">
						<li class="page-item active" aria-current="page"><a
							class="page-link" href="total_main_search.do?page=${i }&keyword=${keyword }">${i }</a></li>
					</c:if>

					<c:if test="${i != page }">
						<li class="page-item" ><a class="page-link"
							href="total_main_search.do?page=${i }&keyword=${keyword }">${i }</a></li>
					</c:if>
				</c:forEach>
				...
				<c:if test="${endBlock < allPage }">
					<li class="page-item"><a class="page-link"
						href="total_main_search.do?page=${page + 1 }&keyword=${keyword }">다음</a></li>

					<li class="page-item"><a class="page-link"
						href="total_main_search.do?page=${allPage }&keyword=${keyword }">마지막</a></li>
				</c:if>
