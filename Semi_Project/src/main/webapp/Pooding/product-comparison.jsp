					...
					<li class="nav-item dropdown">
						<div class="flex-grow-1 pb-3 pt-sm-3 my-1 pr-lg-4 order-sm-2">
							<div class="input-group flex-nowrap">
								<div class="input-group-prepend">
									<span class="input-group-text rounded-left" id="search-icon"><i
										data-feather="search"></i></span>
								</div>
								<input class="form-control rounded-right" type="text"
									id="site-search" placeholder="Search site"
			...
			<table class="table table-bordered">
					...
					<tr>
						...
						<td>
							<div class="comparison-item">
								<span class="remove-item"><i data-feather="x"></i></span><a
									class="comparison-item-thumb" href="shop-single.html"><img
									src="img/shop/comparison/01.jpg" alt="Apple iPhone Xs Max"></a><a
									class="comparison-item-title" href="shop-single.html">Apple
									iPhone Xs Max</a>
								<button class="btn btn-pill btn-outline-primary btn-sm"
									type="button" data-toggle="toast" data-target="#cart-toast">Add
									to Cart</button>
							</div>
						</td>
						<td>
							<div class="comparison-item">
								<span class="remove-item"><i data-feather="x"></i></span><a
									class="comparison-item-thumb" href="shop-single.html"><img
									src="img/shop/comparison/02.jpg" alt="Google Pixel 3 XL"></a><a
									class="comparison-item-title" href="shop-single.html">Google
									Pixel 3 XL</a>
								<button class="btn btn-pill btn-outline-primary btn-sm"
									type="button" data-toggle="toast" data-target="#cart-toast">Add
									to Cart</button>
						...
						<td>
							<div class="comparison-item">
								<span class="remove-item"><i data-feather="x"></i></span><a
									class="comparison-item-thumb" href="shop-single.html"><img
									src="img/shop/comparison/03.jpg" alt="Samsung Galaxy S10+"></a><a
									class="comparison-item-title" href="shop-single.html">Samsung
									Galaxy S10+</a>
								<button class="btn btn-pill btn-outline-primary btn-sm"
									type="button" data-toggle="toast" data-target="#cart-toast">Add
									to Cart</button>
				...
				<tbody id="summary" data-filter="target">
					<tr class="bg-secondary">
						...
						<td><span class="text-dark font-weight-semibold">Apple
								iPhone Xs Max</span></td>
						<td><span class="text-dark font-weight-semibold">Google
								Pixel 3 XL</span></td>
						<td><span class="text-dark font-weight-semibold">Samsung
								Galaxy S10+</span></td>
					</tr>
					<tr>
						<th>Performance</th>
				...
				<tbody id="general" data-filter="target">
					...
					<tr>
						<th>Network</th>
						<td>4G: Available (supports Indian bands) 3G: Available, 2G:
							Available</td>
						<td>4G: Available (supports Indian bands) 3G: Available, 2G:
							Available</td>
						<td>4G: Available (supports Indian bands) 3G: Available, 2G:
				...
				<tbody id="design" data-filter="target">
					...
					<tr>
						<th>Waterproof</th>
						<td>Yes Water resistant (up to 30 minutes in a depth of 1
							meter), IP67</td>
						<td>Yes Water resistant (up to 30 minutes in a depth of 1
							meter), IP67</td>
						<td>Yes Water resistant (up to 30 minutes in a depth of 1.5
							meter), IP68</td>
					</tr>
					<tr>
						<th>Colors</th>
				...
				<tbody id="camera" data-filter="target">
					...
					<tr>
						...
						<td>10 x Digital zoom, Optical zoom, Auto flash, Face
							detection, Touch to focus</td>
						<td>Fixed zocus</td>
					...
					<tr>
						...
						<td>Continuos shooting, High dynamic range mode (HDR), Burst
							mode</td>
