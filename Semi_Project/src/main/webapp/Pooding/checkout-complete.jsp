      ...
      <div class="pt-5">
        <div class="card py-3 mt-sm-3">
          <div class="card-body text-center">
            ...
            <p class="mb-2">Make sure you make note of your order number, which is <strong>34VB5540K83.</strong></p>
            <p>You will be receiving an email shortly with confirmation of your order. <u>You can now:</u></p><a class="btn btn-secondary mt-3 mr-3" href="shop-style1-ls.jsp">Go back shopping</a><a class="btn btn-primary mt-3" href="order-tracking.jsp"><i data-feather="map-pin"></i>&nbsp;Track order</a>
          </div>
        </div>
      </div>
    </div>
