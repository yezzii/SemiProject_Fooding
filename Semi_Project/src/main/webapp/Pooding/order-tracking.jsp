  ...
  <body>
    ...
    <div class="page-title-wrapper" aria-label="Page title">
      <div class="container">
        ...
        <h1 class="page-title">Tracking order: <span class="h3 font-weight-semibold">34VB5540K83</span></h1><span class="d-block mt-2 text-muted"></span>
        <hr class="mt-4">
      </div>
    </div>
    <!-- Page Content-->
    <div class="container pb-5 mb-sm-4">
      ...
      <div class="steps">
        ...
        <div class="steps-body">
          <div class="step step-completed"><span class="step-indicator"><i data-feather="check"></i></span><span class="step-icon"><i data-feather="check-circle"></i></span>Order confirmed</div>
          <div class="step step-completed"><span class="step-indicator"><i data-feather="check"></i></span><span class="step-icon"><i data-feather="settings"></i></span>Processing order</div>
          <div class="step step-active"><span class="step-icon"><i data-feather="award"></i></span>Quality check</div>
          <div class="step"><span class="step-icon"><i data-feather="truck"></i></span>Product dispatched</div>
          <div class="step"><span class="step-icon"><i data-feather="home"></i></span>Product delivered</div>
        </div>
      </div>
      <!-- Footer-->
