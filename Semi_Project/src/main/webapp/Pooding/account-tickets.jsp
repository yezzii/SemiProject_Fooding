      ...
      <div class="row pt-5">
        ...
        <div class="col-lg-8 offset-xl-1">
          ...
          <div class="d-flex pt-3 flex-wrap justify-content-between align-items-center">
            <h5 class="mb-3 mr-2">My tickets<span class="font-weight-normal text-muted ml-1">(1)</span></h5>
          ...
          <div class="form-inline pb-4 pt-3">
            <label class="text-muted mr-3" for="tickets-sort">Sort tickets</label>
            <select class="form-control custom-select" id="tickets-sort">
              <option>All</option>
              <option>Open</option>
          ...
          <div class="table-responsive font-size-sm">
            <table class="table table-hover mb-0">
              ...
              <tbody>
                <tr>
                  <td><a class="nav-link-inline" href="account-single-ticket.html">My new ticket</a></td>
                  <td>05/08/2019 | 05/14/2019</td>
                  <td>Website problem</td>
                  <td><span class="badge badge-warning m-0">High</span></td>
                  <td><span class="badge badge-primary m-0">Open</span></td>
                </tr>
                <tr>
                  <td><a class="nav-link-inline" href="account-single-ticket.html">Another ticket</a></td>
                  <td>07/21/2018 | 07/23/2018</td>
                  <td>Partner request</td>
                  <td><span class="badge badge-info m-0">Medium</span></td>
                  <td><span class="badge badge-secondary m-0">Closed</span></td>
                </tr>
                <tr>
                  <td><a class="nav-link-inline" href="account-single-ticket.html">Yet another ticket</a></td>
                  <td>05/19/2018 | 05/20/2018</td>
                  <td>Complaint</td>
                  <td><span class="badge badge-danger m-0">Urgent</span></td>
                  <td><span class="badge badge-secondary m-0">Closed</span></td>
                </tr>
                <tr>
                  <td><a class="nav-link-inline" href="account-single-ticket.html">My old ticket</a></td>
                  <td>05/19/2018 | 05/20/2018</td>
                  <td>Info inquiry</td>
          ...
          <hr class="mb-4">
          <div class="text-right">
            <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#open-ticket">Submit new ticket</button>
          </div>
