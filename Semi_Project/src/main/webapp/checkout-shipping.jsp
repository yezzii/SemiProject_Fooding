...
<html lang="en">
  ...
  <body>
    ...
    <div class="container pb-5 mb-sm-4 mt-n2 mt-md-n3">
      <!-- Steps (wizard)-->
      <div class="steps">
        <div class="steps-body"><a class="step step-completed" href="cart.jsp"><span class="step-indicator"><i data-feather="check"></i></span><span class="step-icon"><i data-feather="shopping-cart"></i></span>1. Shopping cart</a><a class="step step-completed" href="checkout-details.jsp"><span class="step-indicator"><i data-feather="check"></i></span><span class="step-icon"><i data-feather="user"></i></span>2. Your details</a><a class="step step-active" href="checkout-shipping.jsp"><span class="step-icon"><i data-feather="truck"></i></span>3. Shipping</a><a class="step" href="checkout-payment.jsp"><span class="step-icon"><i data-feather="credit-card"></i></span>4. Payment</a><a class="step" href="checkout-review.jsp"><span class="step-icon"><i data-feather="check-circle"></i></span>5. Final review</a></div>
      </div>
      <div class="row pt-4 mt-2">
        ...
        <div class="col-xl-9 col-md-8">
          ...
          <div class="d-flex pt-2">
            <div class="w-50 pr-3"><a class="btn btn-outline-secondary btn-block" href="checkout-details.jsp"><i class="mr-1" data-feather="chevron-left"></i>Back</a></div>
            <div class="w-50 pl-2"><a class="btn btn-primary btn-block" href="checkout-payment.jsp"><span class="d-none d-sm-inline">Proceed to payment</span><span class="d-inline d-sm-none">Next</span><i class="ml-1" data-feather="chevron-right"></i></a></div>
          </div>
        </div>
        <!-- Sidebar-->
