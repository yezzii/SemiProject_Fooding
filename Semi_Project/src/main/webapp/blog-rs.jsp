  ...
  <body>
    ...
    <div class="page-title-wrapper" aria-label="Page title">
      <div class="container">
        ...
        <h1 class="page-title">Blog right sidebar</h1><span class="d-block mt-2 text-muted"></span>
        <hr class="mt-4">
      </div>
    </div>
    <!-- Page Content-->
      ...
      <div class="row">
        <div class="col-lg-9">
          ...
          <div class="row pb-5">
            ...
            <div class="col-md-8"><a class="d-block mb-3" href="blog-single-rs.jsp"><img class="d-block" src="img/blog/01.jpg" alt="Post thumb"></a>
              <p class="font-size-sm">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni...</p>
              <div class="post-meta">
                <div>
                   in&nbsp;<a href="#">Fashion, &nbsp;</a><a href="#">Travelling</a><span class="meta-divider"></span><a href="#">#apparel</a></div>
              </div>
            </div>
          </div>
          <hr class="pb-5">
          ...
          <div class="row pb-5">
            <div class="col-md-4">
              <div class="post-meta d-flex flex-wrap justify-content-between pb-3">
                <div class="mr-2">by&nbsp;<a href="#">Paul Goodrich</a><span class="meta-divider"></span><a href="#">Mar 16</a></div><a href="#"><i class="mr-1" data-feather="message-square"></i>24</a>
              </div>
              <h3 class="h4 mb-4"><a class="post-title" href="blog-single-rs.jsp">Smart homes become even more smart</a></h3>
            </div>
            <div class="col-md-8"><a class="d-block position-relative mb-3" href="https://player.vimeo.com/video/203972818?title=0&amp;byline=0&amp;portrait=0" data-fancybox data-width="1000" data-height="563">
                <div class="video-player-btn position-absolute" style="top: 50%; left: 50%; margin-top: -2.25rem; margin-left: -2.25rem;"><i data-feather="play"></i></div><img class="d-block" src="img/blog/02.jpg" alt="Post thumb"></a>
              <p class="font-size-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat...</p>
              <div class="post-meta">
                <div>
          ...
          <div class="row pb-5">
            <div class="col-md-4">
              <div class="post-meta d-flex flex-wrap justify-content-between pb-3">
                <div class="mr-2">by&nbsp;<a href="#">Cynthia Gomez</a><span class="meta-divider"></span><a href="#">Feb 19</a></div><a href="#"><i class="mr-1" data-feather="message-square"></i>8</a>
              </div>
              <h3 class="h4 mb-4"><a class="post-title" href="blog-single-rs.jsp">Global travel and vacations on a tight budget</a></h3>
            </div>
            <div class="col-md-8">
              <p class="font-size-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse. Aliquid id nobis, amet dolorum earum maxime. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo...</p>
              <div class="post-meta">
                <div>
                   in&nbsp;<a href="#">Travelling, &nbsp;</a><a href="#">Vacations,</a></div>
              </div>
            </div>
          </div>
          <hr class="pb-5">
          ...
          <div class="row pb-5">
            <div class="col-md-4">
              <div class="post-meta d-flex flex-wrap justify-content-between pb-3">
                <div class="mr-2">by&nbsp;<a href="#">Logan Coleman</a><span class="meta-divider"></span><a href="#">Jan 27</a></div><a href="#"><i class="mr-1" data-feather="message-square"></i>31</a>
              </div>
              <h3 class="h4 mb-4"><a class="post-title" href="blog-single-rs.jsp">How To Make Professional Video With Drones</a></h3>
            </div>
            <div class="col-md-8"><a class="d-block mb-3" href="blog-single-rs.jsp"><img class="d-block" src="img/blog/03.jpg" alt="Post thumb"></a>
              <p class="font-size-sm">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni...</p>
              <div class="post-meta">
                <div>
                   in&nbsp;<a href="#">Consumer electronics</a><span class="meta-divider"></span><a href="#">#drones</a></div>
              </div>
            </div>
          </div>
          <hr class="pb-4 mb-2">
            ...
            <div class="offcanvas-sidebar-body">
              <div class="offcanvas-sidebar-body-inner">
                ...
                <div class="widget widget-categories mb-4 py-1">
                  ...
                  <ul>
                    <li><a href="#"><i class="widget-categories-indicator" data-feather="chevron-right"></i>Editor's choise<span class="badge text-muted ml-1">(25)</span></a></li>
                    <li><a href="#"><i class="widget-categories-indicator" data-feather="chevron-right"></i>Online shopping<span class="badge text-muted ml-1">(13)</span></a></li>
                    <li><a href="#"><i class="widget-categories-indicator" data-feather="chevron-right"></i>Clothing design<span class="badge text-muted ml-1">(9)</span></a></li>
                    <li><a href="#"><i class="widget-categories-indicator" data-feather="chevron-right"></i>Electronics<span class="badge text-muted ml-1">(34)</span></a></li>
                    <li><a href="#"><i class="widget-categories-indicator" data-feather="chevron-right"></i>Smart gadgets<span class="badge text-muted ml-1">(28)</span></a></li>
                    <li><a href="#"><i class="widget-categories-indicator" data-feather="chevron-right"></i>Lifestyle<span class="badge text-muted ml-1">(16)</span></a></li>
                  </ul>
                </div>
                <!-- Featured posts-->
                <div class="widget widget-featured-entries mb-4 pb-2">
                  <h3 class="widget-title">Featured posts</h3>
                  <div class="media"><a class="featured-entry-thumb" href="#"><img src="img/blog/widget/01.jpg" width="64" alt="Post thumb"></a>
                    <div class="media-body">
                      <h6 class="featured-entry-title"><a href="#">Retro cameras are trending. Why so popular?</a></h6>
                      <p class="featured-entry-meta text-muted">by Andy Williams</p>
                    </div>
                  </div>
                  <div class="media"><a class="featured-entry-thumb" href="#"><img src="img/blog/widget/02.jpg" width="64" alt="Post thumb"></a>
                    <div class="media-body">
                      <h6 class="featured-entry-title"><a href="#">New trends in suburban fashion</a></h6>
                      <p class="featured-entry-meta text-muted">by Susan Mayer</p>
                    </div>
                  </div>
                  <div class="media"><a class="featured-entry-thumb" href="#"><img src="img/blog/widget/03.jpg" width="64" alt="Post thumb"></a>
                    <div class="media-body">
                      <h6 class="featured-entry-title"><a href="#">Augmented reality - game changing technology</a></h6>
                      <p class="featured-entry-meta text-muted">by John Doe</p>
                    </div>
                  </div>
                </div>
                <!-- Tags      -->
                <div class="widget mb-4 pb-1">
                  <h3 class="widget-title">Popular tags</h3><a class="tag-link mr-2 mb-2" href="#">#accessories</a><a class="tag-link mr-2 mb-2" href="#">#smart devices</a><a class="tag-link mr-2 mb-2" href="#">#apparel</a><a class="tag-link mr-2 mb-2" href="#">#handbags</a><a class="tag-link mb-2" href="#">#IoT</a>
                </div>
                <!-- Promo banner--><a class="d-block position-relative text-decoration-0 bg-size-cover bg-position-center py-3" href="#" style="background-image: url(img/blog/promo-bg.jpg);"><span class="bg-overlay"></span>
                  <div class="bg-overlay-content text-center py-5 px-3">
                    <h5 class="text-white"><span class='d-block font-weight-normal'>New 2019</span>Sunglasses Collection</h5>
                    <div class="btn btn-primary btn-pill btn-sm">Shop now</div>
                  </div></a>
              </div>
            </div>
          </div>
