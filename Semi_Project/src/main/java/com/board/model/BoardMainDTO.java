...
public class BoardMainDTO {
	...
	public String getMain_memberId() {
		return main_memberId;
	}

	public void setMain_memberId(String main_memberId) {
		this.main_memberId = main_memberId;
	}
